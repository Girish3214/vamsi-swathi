  ...
  return (
    <div className="relative w-full max-w-sm px-10 py-10 md:py-12 rounded-[22px] bg-card/60 text-center space-y-5 border border-primary/10 shadow-[0_8px_24px_rgba(63,46,41,0.08)] before:absolute before:inset-0 before:rounded-[22px] before:pointer-events-none before:bg-[radial-gradient(120%_120%_at_0%_0%,rgba(233,178,52,0.04)_0%,rgba(233,178,52,0.02)_35%,rgba(233,178,52,0.08)_100%)] after:absolute after:inset-[10px] after:rounded-[14px] after:border after:border-primary/15 after:pointer-events-none overflow-hidden">
      ...
      <div className="flex justify-center items-center gap-2">
        <span className="opacity-60 text-md text-primary font-semibold tracking-wider">
          📞
        </span>
        <a
          href={`tel:${phone}`}
